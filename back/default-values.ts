...
export const defaultRecettes = [
  {
    ...
    ingredients: { tomate: 7, "pâte feuilletée": 1, "pignons de pain": 1 },
    type: "flemme",
  ...
  },
  {
    ...
    ingredients: { lentille: 1, féta: 1, pomme: 1, "choux rouge": 1 },
    type: "flemme",
  },
  {
    name: "Couscous végé",
  ...
  // One shot
  { name: "PQ", type: "singleItem", ingredients: { PQ: 1 } },
  { name: "café", type: "singleItem", ingredients: { café: 1 } },
  { name: "dentrifice", type: "singleItem", ingredients: { dentrifice: 1 } },
  {
    name: "tablettes lave vaisselle",
    type: "singleItem",
    ingredients: { "tablettes lave vaisselle": 1 },
  },
  {
    name: "liquide rincage",
    type: "singleItem",
    ingredients: { "liquide rincage": 1 },
  },
  { name: "lessive", type: "singleItem", ingredients: { lessive: 1 } },
  { name: "tampon", type: "singleItem", ingredients: { tampon: 1 } },
  { name: "beurre", type: "singleItem", ingredients: { beurre: 1 } },
  { name: "chocolat", type: "singleItem", ingredients: { beurre: 1 } },
  {
    name: "huile d'olive",
    type: "singleItem",
    ingredients: { "huile d'olive": 1 },
  },
  { name: "vinaigre", type: "singleItem", ingredients: { vinaigre: 1 } },
  { name: "sel", type: "singleItem", ingredients: { sel: 1 } },
  { name: "poivre", type: "singleItem", ingredients: { poivre: 1 } },
  { name: "sirop", type: "singleItem", ingredients: { sirop: 1 } },
  { name: "fruits", type: "singleItem", ingredients: { fruits: 1 } },
];
